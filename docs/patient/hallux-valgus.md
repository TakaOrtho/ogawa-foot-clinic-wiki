...
「親指の付け根が痛くて、靴選びに困っている」「外反母趾は手術しかないと言われたが、できれば避けたい」 — そのようなお気持ちをお持ちではありませんか。
...
<figcaption>左：歩幅を小さくして、**後ろ足が前足を追い越さない** ように歩く（適切）　／　右：通常の歩き方では後ろ足の **親指の付け根（MTP）が反って蹴り出す**「**踏み返し**」が起きてしまいます（避けるべき動作・矢印部分） — 矯正した骨に負担をかけないため、最初の 6 週間は踏み返しを避けてください。</figcaption>
</figure>
...
→ **動かしてよいのは「指」、避けるべきなのは「踏み返し（蹴り出し）」** と覚えてください。
