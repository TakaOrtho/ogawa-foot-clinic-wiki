...
「親指の付け根が痛くて、靴選びに困っている」「症状にずっと困っている」「治療法がないと言われたが、どうしたらよいか迷っている」 — そのようなお気持ちをお持ちではありませんか。
外反母趾は、**見た目の曲がりだけで手術を決める病気ではありません**。痛みで歩きにくい、靴が合わない、日常生活に支障があるときに、手術を選択肢として考えます。
このページでは、外反母趾の治療の考え方を、患者さんの目線でご説明します。
...
- **靴の見直し** — 先の広い、ヒールの低い靴を選びます
- **足の指の運動** — タオルギャザー、足指じゃんけん
- 痛み止め（飲み薬・湿布）

!!! tip "インソールは「続ける」ことが重要です"
    インソールは **続けて使い続けないと効果が薄れます**。「痛みが減ったからやめる → また痛くなる → 通院」を繰り返さないように、日常的な使用を心がけてください。
...
「整形外科の手術」と聞くと不安に感じる方もいます。当院では **傷跡が小さく、負担の少ない手術（MICA法）** を行っています。
...
- 第2・3趾の付け根が痛く、足の裏にタコがある方には、**第2・3の中足骨の首の部分を小さく骨切り** します
...
- **包帯は、ご自身では外さないでください**（矯正位がずれてしまいます）
...
!!! warning "最初の2週間の最優先事項"
    ...
    - **胸（心臓）の高さより高く** 足を上げて過ごす（クッション・オットマン・枕などを活用、台や椅子の上に足を置くなど）
    - **座っているとき、寝ているときも常に挙上**
...
<figcaption>術後6週間使用する「専用サンダル（前足部ヒール靴）」。かかとが厚く、底が固いために、前足部に体重がかかりません。</figcaption>
</figure>
...
| 時期 | 履物 |
|------|------|
| 0〜2週（抜糸まで） | **専用サンダル（前足部ヒール靴：かかとが厚く、底が固い）** |
| 2〜6週 | **専用サンダル** を継続 |
...
- **足の指は痛みのない範囲で積極的に動かします**（拘縮予防のため、むしろ推奨）
- ただし **踏み返し（つま先で地面を蹴る動作）は禁止**
- 寝ているとき・座っているときに、自分で足の指をグー・パーする運動を行ってください
...
!!! danger "すぐ病院へ"
    以下の症状は、感染や血流障害のサインのことがあります。病院へご連絡ください。
...
??? question "傷あとは目立ちますか？"
    MICA は 2〜3mmの傷が数か所のみで、数か月で目立ちにくくなります。傷あとが気になる方もいらっしゃいますが、多くの場合、半年ほどでほとんどわからなくなります。

??? question "もう一度ハイヒールを履けますか？"
    術式選択が適切で、術後の靴・インソールを続けていれば再発リスクは低いですが、 **ハイヒールを再開するとまた進行する** ことがあります。お祝いの席など、短時間の使用は可能な場合がありますが、毎日のご使用はおすすめしません。

??? question "なぜ翌日から指を動かすのですか？痛みはありますか？"
    親指の付け根の関節は **動かさないと固まりやすい** ためです。固まると、あとで動きが悪くなってしまいます。痛みがある場合でも、無理のない範囲で少しずつ動かすほうが、長期的に楽になります。痛み止めを使いながら、医師・理学療法士の指示に従って動かしてください。
