...
このページでは、変形性足関節症の特徴と、3種類の手術の選び方を、できるだけわかりやすくご説明します。
...
- 朝起きたとき、最初の一歩が痛い
- 動かすと痛みがあり、関節を動かせる範囲が狭くなったように感じる
- 朝はこわばっている
- 進行すると、安静にしていても痛い
- 足首が内側に傾いてきた（内反変形）
...
- 装具（足首サポーター、足底板、特殊な靴）
- **関節注射**（ヒアルロン酸、ステロイド）
- リハビリ（関節を動かせる範囲、筋力、歩き方）

これだけで、長く症状を管理できる方も多くいらっしゃいます。
...
「足首が動かなくなること」を心配される方も多いですが、実際には **歩行への支障は限定的** です。痛みを確実に取りたい、重労働を続けたい、という方には有効な選択肢です。

### 4-4. 手術の比較表

| 比較項目 | 骨切り術 | 人工足関節 | 関節固定術 |
|------|----------|----------|----------|
| 自分の関節 | **残せる** | 人工の関節に置き換える | 骨でくっつけて動かなくする |
| 足首の動き | 自然に動かせる | 動かせる | 動かない |
| 痛み | 関節への負担を減らして和らげる。時間とともに進むこともある | 約9割の方で良好 | **ほぼ確実に取れる** |
| 足をつかない期間 | **6週間** | 2〜4週から少しずつ。**4週で全体重** | **6〜12週間** |
| ふだんの生活の目安 | 3か月後くらいから自由に歩ける | 3〜6か月でほぼ問題なし | 3〜6か月でほぼ復帰 |
| どのくらい持つか | 進むことがある。そのときは次の手術に進める | 10〜20年。再手術が必要になることもある | 数十年。通常は再手術不要 |
| 重い仕事 | — | 控えていただく | 続けられる |
| ランニング | — | 控えていただく | 控えていただく |
| でこぼこした道 | — | 歩きやすい | やや歩きにくい |
| 隣の関節への影響 | — | 比較的少ない | 長く経つと悪くなることがある |
...
??? question "両足とも変形性足関節症ですが、同時手術はできますか？"
    通常は片足ずつです。両足とも体重をかけられない期間が長くなると、生活が困難になってしまうためです。

??? question "手術しないとどうなりますか？"
    進行性の病気ですので、徐々に痛みが強くなり、歩行が困難になっていきます。ただし進行のスピードには **個人差が大きく**、保存治療で症状を管理できれば手術が不要な方も多くいらっしゃいます。
...
??? question "家族にどう説明すればよいか不安です"
    手術内容や術後の生活については、ご家族の方も一緒に診察にお越しいただいて構いません。当院では、ご家族の方への説明の時間も別途設けることができます。必要に応じてご相談ください。
