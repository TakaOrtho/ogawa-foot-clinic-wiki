...
足首の外側（くるぶしのほう）には、**靱帯（じんたい）** という丈夫な“スジ”があり、足首が内側にひねりすぎないように支えています。
この靱帯が傷んでゆるくなると、何度も足首をひねったり、ふとした拍子に「ガクッ」とする状態が続きます。これを **足関節不安定症** といいます。

### 「捻挫」と「足関節不安定症」は別の病気？

実は **同じ病気のつながり（連続した1つの病態）** と考えます。
急に強くひねる捻挫の延長線上に、慢性的なぐらつきがあるイメージです。

### 原因は大きく2つ

- **① スポーツなどの急な捻挫**（若い方に多い）
- **② 加齢にともなう靱帯のゆるみ**（中高年に多く、はっきりした捻挫の記憶がないまま進むことも）
...
- 1〜2か月のリハビリで、6〜7割の方は改善します
- 足首の動き、腓骨筋の筋力、バランス感覚を取り戻すトレーニング
- スポーツ時はサポーター・ブレースの活用

### 3-2. 手術を考えるとき

- リハビリを2〜3か月以上続けても **不安定感や痛みが残る**
- スポーツや仕事に **支障が大きい**
- 軟骨損傷など、追加の治療が必要なものが見つかった
- 加齢でゆるみが進み、明らかに歩きにくい

「手術は怖い」と感じる方も少なくありません。当院では **小さな内視鏡（関節鏡）を使う、傷の小さい手術** を行っており、術後の負担を軽減できます（入院は日帰りから2泊3日、翌日から歩行可能になるなど）。

---

## 4. 当院の手術：関節鏡視下 靱帯縫合術（Broström手技）
...
- 軟骨の傷や骨のトゲなど、ほかのトラブルも同時に治療できます
- 大きな傷を作らないので、回復が早く、傷あとも目立ちにくいのが利点です

### 4-2. 麻酔と入院

- 麻酔：全身麻酔 + 神経ブロック（術後の痛みを和らげるブロックを併用）
    - ※日帰りの場合や希望によって神経ブロックのみ（意識があるが痛みのない状態で可能）
- 手術時間：1時間前後
- 入院期間：日帰り〜2泊3日

※患者さんの足の重症度とご希望によって異なります
...
!!! info "後療法のポイント"
    ...
    - 抜糸：**手術後10〜14日**
    - **包帯またはサポーター：6週間**
    - シャワー・入浴：抜糸前は濡らさなければシャワー可、抜糸後は入浴も許可
...
| 時期 | 状態 |
|------|------|
| 当日〜翌日 | 足を高く上げて安静、痛み止めを使います。トイレなどの歩行は許可（シーネや包帯をつけた状態で） |
| **翌日** | **歩行許可**（包帯・サポーターをつけた状態で） |
| 退院前 | 傷の管理、サポーターの扱い、危険サインを一緒に確認します |

!!! info "最初の3日間：少し痛みが出ることがあります"
    - 術後3日間ほどは、**腫れや痛み** が出やすい時期です。無理をせず **安静を意識して過ごしてください**
    - **歩くこと自体は問題ありません**。翌日から **トイレや洗面所までご自身で歩行できます**
    - ただし、長時間の立位・歩行は避けて、できるだけ **足を高く上げて休む時間** をとりましょう
    - 痛みが強いときは我慢せず、処方された痛み止めを使ってください

### 5-2. 退院後のスケジュール

| 内容 | 翌日〜2週 | 2〜6週 | 6週〜 | 3〜6か月 |
|------|:---:|:---:|:---:|:---:|
| 包帯・サポーター | ● | ● |  |  |
| スポーツ時のブレース |  |  | ● | ● |
| 歩行 | ● | ● | ● | ● |
...
- 抗血栓薬（血をサラサラにする薬）など、休んでいた薬の再開は **医師の指示に従って** ください（基本的に内服薬をつづけたまま手術します）

### 5-5. 階段の上り下り（覚えておくと安心）
...
??? question "本当に翌日から歩けますか？"
    はい。関節鏡を使う小さな傷の手術なので、組織への負担が少なく、しっかり固定できます。痛みのない範囲で、包帯・サポーターをつけて歩いていただきます。最初は短い距離から、少しずつ歩行します。

??? question "両足同時に手術できますか？"
    通常は片足ずつ行います。当院プロトコルなら翌日から歩けるので、片足ずつでも生活への影響は少なく済みます。

??? question "スポーツ復帰は、本当に6週間が目安ですか？"
...
??? question "「症状は弱いが不安」というだけでも、受診できますか？"
    受診できます。慢性期の症状はわかりにくく、本人も病院も見逃しがちです。「年のせい」と決めつけず、一度ご相談ください。
